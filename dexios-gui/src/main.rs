    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            ui.collapsing("Encrypt a file or directory", |ui| {
                ...
                ui.add_enabled_ui(self.encrypt.key == Key::Password, |ui| {
                    ui.horizontal(|ui| {
                        ui.label("Password: ");
                        ui.add(
                ...
                ui.add_enabled_ui(self.encrypt.key == Key::Keyfile, |ui| {
                    ui.horizontal(|ui| {
                        ui.label("Keyfile: ");
                ...
                ui.add_enabled_ui(self.encrypt.key == Key::AutoGenerate, |ui| {
                    ui.horizontal(|ui| {
                ...
                if ui.button("Encrypt").clicked() {
                    ...
                    if !std::path::PathBuf::from(self.encrypt.input_path.clone()).is_dir() {
                        // encrypt
                        ...
                        let input_dir = vec![self.encrypt.input_path.clone()]
                            .iter()
                            .map(|dir_name| stor.read_file(dir_name))
                            .collect::<Result<Vec<_>, _>>()
                            .unwrap();

                        let file_list = input_dir
                            .into_iter()
                            .flat_map(|file| {
                                if file.is_dir() {
            ...
            ui.collapsing("Decrypt a file", |ui| {
                ...
                ui.add_enabled_ui(self.decrypt.key == Key::Password, |ui| {
                    ui.horizontal(|ui| {
                        ui.label("Password: ");
                        ui.add(
                ...
                ui.add_enabled_ui(self.decrypt.key == Key::Keyfile, |ui| {
                    ui.horizontal(|ui| {
                        ui.label("Keyfile: ");
